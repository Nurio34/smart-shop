...
function Theme() {
  ...
  return (
    <label className="swap swap-rotate">
      ...
      {/* Sun Icon */}
      <svg
        className={`swap-off w-8 aspect-square fill-orange-300 stroke-orange-400 transition-all`}
      ...
      {/* Moon Icon */}
      <svg
        className="swap-on w-8 aspect-square fill-yellow-400 stroke-yellow-600 transition-all"
        xmlns="http://www.w3.org/2000/svg"
        viewBox="0 0 24 24"
      >
